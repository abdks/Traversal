...
namespace Traversal.Controllers
{
    public class ExcelController : Controller
    {
        ...
        public IActionResult StaticExcelReport()
        {
            ...
            //workSheet.Cells[2, 2].Value = "Kadir";
            //workSheet.Cells[2, 3].Value = "50";

            //workSheet.Cells[3, 1].Value = "Romanya Batum Turu";
            //workSheet.Cells[3, 2].Value = "apo";
            //workSheet.Cells[3, 3].Value = "50";
            //var bytes = excel.GetAsByteArray();

            // return File(bytes, "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet", "dosya11.xlsx");
